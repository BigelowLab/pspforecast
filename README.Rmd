...
```{r cm_23, echo=FALSE, cahce=FALSE}
num_levels <- 4
...
```{r scatter_23, echo=FALSE, cache=FALSE}
...
p3_v_tox <- ggplot2::ggplot(data = pred_w_results, ggplot2::aes(x=.data$prob_3, y=.data$toxicity)) +
  ggplot2::geom_point(alpha=0.7, size=3) +
  ggplot2::labs(x = "Predicted Probability of Closure-level Toxicity",
                y = "Measured Toxicity") +
  ggplot2::geom_hline(yintercept=80, linetype="dashed")
