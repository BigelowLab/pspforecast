...
psp <- read_sslabims(base_url = user_config$pspdata$base_url, 
                     data_url = user_config$pspdata$data_url, 
                     login = user_config$pspdata$login, 
                     password = user_config$pspdata$password,
                     model_ready=TRUE)
```
