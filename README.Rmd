...
## Metrics:
 ...
 + closure_level_acc - Accuracy of correctly predicted closure-level (class 3) measurements
...
c3_measurements <- pred_w_results |>
  filter(class == 3) |>
  nrow()
...
metrics <- tibble(overall_acc = correct/nrow(pred_w_results),
                  closure_level_acc = c3_correct/c3_measurements)
